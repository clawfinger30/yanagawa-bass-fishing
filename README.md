...
| リグ | 主なワーム | フック / ジグヘッド | シンカー / ウェイト | ライン | 導入目安 |
|---|---|---|---|---|---|
| **ジグヘッド** | HP Shadtail 3.1 / STIRRING SHAD 2.8・3.3 / Easy Shiner 3 / Swing Impact 3 | **1.8〜2.7g基本**、予備1.3・3.5g | ジグヘッド自重 | **フロロ4〜6lb** | 5,000円〜 |
| **ワッキーDS** | DoLive Crawler 3.5 / FINESSE STRAIGHT 4.3 / Live Impact 3 | **マス針#4基本**、予備#6・#2 | **DS 2.7g基本**、予備1.8・3.5g | **フロロ4〜6lb** | 5,000円〜 |
| **フリーリグ O.S.P** | DoLive Beaver 3.5 | **オフセット#1/0〜#2/0** | **3.5〜5g、基本5g** | **フロロ10〜14lb** | O.S.P 10,000円〜 |
| **フリーリグ KEITECH / 混成** | Crazy Flapper 2.8 | **オフセット#1** | **3.5〜5g、基本5g** | **フロロ10〜14lb** | 10,000円〜 |
| **ウェイテッドフック** | Swing Impact FAT 3.8 | **#2/0** | **1.8〜3.5g** | **フロロ10〜14lb** | KEITECH 5,000円〜 / 混成15,000円〜 |
| **ウェイテッドフック** | Swing Impact FAT 3.3 | **#1/0** | **1.8〜3.5g目安** | **フロロ10〜14lb** | KEITECH 15,000円〜 |
...
- ラインをジグヘッドのアイへ直接結ぶ
- ワームをまっすぐ刺し、フックポイントを背中側から出す
- 中層ただ巻きで、護岸沿い・流れ・ベイトがいる場所を探す

### ワッキー掛けダウンショット

- 標準構成ではスイベル不要
- フックをライン途中に結び、タグエンドをフックアイへ通してフックポイントを上向きにする
- タグエンドへDSシンカーを直接装着する
- フック〜シンカーは**50〜70cm**目安
- ワーム中央付近をマス針で横切るように掛ける
- 水門・杭・護岸・見えバスで最後の食わせとして使用する

### フリーリグ

- 接続順：**ライン → アイ付きフリーリグシンカー → オフセットフック**
- テキサス用バレットシンカーとは区別する
- ワームを曲げずにオフセットフックへセットする
- 浮きゴミ、杭、水門、護岸変化、カバー、ボトムを攻める

### ウェイテッドフック

- ラインをフックアイへ直接結ぶ
- Swing Impact FATを曲げずにセットする
- 中層〜やや深めを広く巻いて探す
...
- スナップ：クランク・シャッド用。サイズはルアーとのバランスで選ぶ

**KEITECH縛り**

- Swing Impact FAT 3.8用ウェイテッドフック ×1袋

> サイズ・重量は「基本リグ早見」を参照する。

### 約10,000円構成

**O.S.P**

- DoLive Beaver 3.5用オフセットフック ×1袋
- アイ付きフリーリグシンカー ×1袋

**DAIWA**

- 新しいワーム用リグ用品は基本追加しない
- ジグヘッド、マス針、DSシンカーの予備を優先する

**KEITECH / 混成最強**

- Crazy Flapper 2.8用オフセットフック ×1袋
- アイ付きフリーリグシンカー ×1袋
- ジグヘッド、マス針、DSシンカーの予備

### 約15,000円構成

新しいフィネスリグを増やさず、**既存リグの予備とウェイト違い**を優先する。

- ジグヘッドの予備
- DSシンカーの予備
- マス針の予備
- フリーリグ採用構成ではオフセットフックとフリーリグシンカーの予備
- KEITECHではFAT 3.3を使う場合のみ対応ウェイテッドフックを追加
- 混成最強ではSwing Impact FAT 3.8採用時に対応ウェイテッドフックを追加
...
> フック・シンカー・ラインの基本仕様は **「リグ・ライン・小物【正本】」を参照**する。ここでは各ルアー固有の用途・特徴・カラー・追加候補を中心に記載する。
...
- フック・シンカー・リーダー長・ライン：**「リグ・ライン・小物【正本】」参照**
