...
価格は厳密な上限ではなく目安。**予備・色違いより、役割の違うルアーとリグのバリエーションを優先**する。フック、シンカー、スナップなどの小物類はメーカーを固定しない。
...
- **最後の食わせ**：TOURNAMENT CRAWLER 3.5＋ワッキーDS
  - マス針 **#4基本**
  - DSシンカー **2.7g基本**
- 5,000円級ではカバー・ボトム専用ルアーを入れず、**4種類に絞ってランガン速度を優先**する
- 小物込みでおおむね **5,000〜6,500円程度**を目安とする
...
- **トップ**：DOG-X Jr. COAYU
- **強い巻き**：SV-3 3/8oz DW
- **シャロークランク**：GRIFFON BF SR-X
- **弱いハードベイト**：SHADING-X R 62
- **弱いソフトベイト**：HAZEDONG SHAD 3＋ジグヘッド **1.8〜2.7g**
- **カバー・ボトム**：BOTTLE SHRIMP 3＋フリーリグ
  - オフセット **#1/0〜#2/0**
  - シンカー **5g基本、3.5g予備**
- **最後の食わせ**：TOURNAMENT CRAWLER 3.5＋ワッキーDS
  - マス針 **#4基本**
  - DSシンカー **2.7g基本**
- ハードベイト交換用に小型スナップを用意し、**SV-3は直結**を基本とする
- 小物込みでおおむね **10,000〜12,000円程度**を目安とする

**状況別の使い分け**

- **朝・表層にベイト**：DOG-X Jr. → SV-3 → 反応がなければ移動
- **水門・橋・杭**：SV-3 → GRIFFON → SHADING-X → 魚がいる確信があれば BOTTLE SHRIMP → TOURNAMENT CRAWLER DS
- **先行者あり / ハイプレッシャー**：SHADING-X → HAZEDONG SHAD → TOURNAMENT CRAWLER DS

> 10,000円構成でも毎ポイント7種類すべてを投げない。**場所と状況で枝分かれさせ、同じ地点でのルアー交換を増やしすぎない。**
...
- **弱い巻き**：KEITECH Easy Shiner 3＋ジグヘッド
- **フィネス**：KEITECH Live Impact 3＋ワッキーDS
...
- **カバー・ボトム**：KEITECH Crazy Flapper 2.8＋フリーリグ
...
- **強いソフトベイト**：KEITECH Swing Impact FAT 3.8＋ウェイテッドフック
...
- **弱い巻き**：HP Shadtail 3.1＋ジグヘッド
- **フィネス**：DoLive Crawler 3.5＋ワッキーDS
...
- **シャローサーチ**：PEANUT SR
- **弱い巻き**：STEEZ STIRRING SHAD 2.8＋ジグヘッド
- **フィネス**：STEEZ FINESSE STRAIGHT 4.3＋ワッキーDS
...
- **KEITECH内での強い巻き**：Swing Impact FAT 3.8＋ウェイテッドフック
- **弱い巻き**：Easy Shiner 3＋ジグヘッド
- **フィネス**：Live Impact 3＋ワッキーDS
...
- Swing Impact FAT 3.3：サイズ違いとして追加
...
**フックサイズ・シンカー重量・ラインだけをここで管理する。** 購入数量・価格は「予算別・メーカー別購入リスト」、用途・操作は「予算別ローテーション」「参考ルアー詳細」を参照する。

| リグ / 用途 | 対象 | フック / ジグヘッド | シンカー / ウェイト | ライン |
|---|---|---|---|---|
| **ジグヘッド** | HP Shadtail 3.1 / STIRRING SHAD 2.8・3.3 / Easy Shiner 3 / Swing Impact 3 | **1.8〜2.7g基本**、予備1.3・3.5g | ― | **フロロ4〜6lb** |
| **ワッキーDS** | DoLive Crawler 3.5 / FINESSE STRAIGHT 4.3 / Live Impact 3 | **マス針#4基本**、予備#6・#2 | **DS 2.7g基本**、予備1.8・3.5g | **フロロ4〜6lb** |
| **フリーリグ** | DoLive Beaver 3.5 | **#1/0〜#2/0** | **3.5〜5g、基本5g** | **フロロ10〜14lb** |
| **フリーリグ** | Crazy Flapper 2.8 | **#1** | **3.5〜5g、基本5g** | **フロロ10〜14lb** |
| **ウェイテッド** | Swing Impact FAT 3.8 | **#2/0** | **1.8〜3.5g** | **フロロ10〜14lb** |
| **ウェイテッド** | Swing Impact FAT 3.3 | **#1/0** | **1.8〜3.5g目安** | **フロロ10〜14lb** |
| **小型シャッド** | SILENT SHAD / Soul Shad等 | ― | ― | **フロロ6〜8lb** |
| **クランク** | PEANUT / BLITZ | ― | ― | **フロロ10〜12lb** |
| **スピナーベイト / チャター** | HIGH PITCHER等 | ― | ― | **フロロ12〜14lb** |
| **トップウォーター** | POPX / LOUDER等 | ― | ― | **ナイロン10〜14lb** |

## 接続で迷いやすい点

- **ワッキーDS**：スイベルなしを標準。フック〜シンカーは**50〜70cm**、フックポイントを上向きにする
- **フリーリグ**：**ライン → アイ付きフリーリグシンカー → オフセットフック**。バレットシンカーとは区別する
- **ジグヘッド / ウェイテッド**：ワームを曲げずにまっすぐセットする
...
- **FAT 3.3用ウェイテッドオフセット ×1袋** — 約500〜700円  
...
| モデル | 潜行レンジ目安 | 用途 | カラー |
|---|---:|---|---|
| SSR | 約0.5m | 超シャロー、底を叩きすぎる場所 | ナチュラル / チャート |
| **SR** | **約1.0m** | **柳川の基本・主力** | **ナチュラル / チャート** |
| DR | 約1.5m | 少し深い水路 | ナチュラル / チャート |
| DDR | 約2.0m | 深めの場所 | ナチュラル / チャート |
