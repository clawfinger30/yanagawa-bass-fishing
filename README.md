...
- 想定水深：おおむね **0.5〜2m**
- 基本方針：
  - 約5,000円構成：**強い巻き → 弱い巻き → フィネス → 反応がなければ移動**
  - 約10,000円以上でカバー・ボトム用リグを採用する構成：**強い巻き → 弱い巻き → カバー・ボトム → フィネス → 反応がなければ移動**
  - DAIWA縛りなどカバー・ボトム用リグを採用しない構成では、その工程を省略する
- 他の釣行者が入った後は、巻物だけで粘らずフィネスへ落とす
- 色は固定せず、**ナチュラル系＋チャート/強アピール系**を用意する
- 購入前に可能なら釣具店で実物を確認する
- Amazonリンクは価格・色を固定せず、商品または検索ページへの参照用
- ルアー本体は **O.S.P縛り / DAIWA縛り / KEITECH縛り / 3メーカー混成最強** の4パターンから選び、小物類はメーカーを固定しない

---

# 柳川での基本戦略

10月初旬は、1か所でルアー交換を繰り返すより、**魚を探しながらランガンすることを優先**する。

1. **強い巻き**
   - 風・濁り・水門・広い水路を速く探す
   - O.S.P / DAIWAはスピナーベイト、チャターなど
   - KEITECH縛りでは **スイングインパクトFAT 3.8＋ウェイテッドフック**を最も強い巻きとして扱う
2. **弱い巻き**
   - 強い巻きで反応しない魚を拾う
   - 小型シャッドテール、クランク、シャッドなど
3. **カバー・ボトム**
   - O.S.P / KEITECH / 混成の約10,000円以上など、カバー・ボトム用リグを採用する構成でフィネス前に通す
   - O.S.Pはドライブビーバー、KEITECHはクレイジーフラッパーのフリーリグを使用
   - DAIWA縛りなどカバー・ボトム用リグを採用しない構成では省略する
4. **フィネス**
   - 魚がいる確信がある場所、先行者が入った水門・杭・護岸で最後の食わせとして使用
   - ワッキー掛けダウンショットを基本にする
5. **反応がなければ移動**
   - ルアーの種類を増やして同じ場所で粘りすぎない

> **KEITECH縛りの注意**：KEITECHはソフトベイト中心なので、O.S.P / DAIWAのスピナーベイトほど強いアピールの巻物はない。ここではFAT 3.8のウェイテッドフックを「KEITECH内での強い巻き」とする。
...
- 5,000円構成をすべて使用
- **シャロークランク**：BLITZを追加
- **カバー・ボトム**：DoLive Beaver 3.5＋フリーリグを追加
- HIGH PITCHERは色違いまたはロスト予備を追加
- フィネスは最後までDoLive Crawlerで統一
...
- BLITZ：ナチュラル系＋チャート系
- HP Shadtail：色違いを追加
- DoLive Crawler：色違いを追加
- 主目的は**ロスト対策・カラー対応**
- リグはジグヘッド、ワッキーDS、フリーリグの3種類まで
...
- **フィネス**：STEEZ FINESSE STRAIGHT 4.3＋マス針#4＋DSシンカー2.7g
- ワーム用リグはジグヘッドとワッキーDSだけで開始
...
- PEANUT SRとSpinnerbaitは色違い・予備を追加
- 新しいワーム用リグは増やさない
...
- **0.5〜1m前後**：PEANUT SR / STEEZ SILENT SHAD 54SP SR
- **1〜1.5m前後**：PEANUT DR / STEEZ SILENT SHAD 54SP MR
- **弱い巻き**：STEEZ STIRRING SHAD 2.8 / 3.3
- **フィネス**：STEEZ FINESSE STRAIGHT 4.3
- Spinnerbaitは予備・色違いを追加
...
- リグはウェイテッドフック、ジグヘッド、ワッキーDSの3種類
- ハードルアーは買わず、ソフトベイトだけで組む
...
- Crazy Flapper 2.8はオフセット #1を基本
- Swing Impact FAT 3.8、Easy Shiner 3、Live Impact 3は色違いを追加
- リグはウェイテッドフック、ジグヘッド、ワッキーDS、フリーリグまで
...
- Easy Shiner 3 / Swing Impact 3：ナチュラル系の色違いを追加
- Crazy Flapper 2.8：グリパン系＋濃色系
- Live Impact 3：ナチュラル系を2色程度
- 主目的は**カラー・サイズ・ロスト対応**
- リグは10,000円構成の4種類まで
...
ハードルアーは「リグ」ではないため、ワーム用リグとは分けて管理する。

### 約5,000円から使う

- **O.S.P**：HIGH PITCHER 3/8oz
- **DAIWA**：STEEZ Spinnerbait 3/8oz、PEANUT SR
- **KEITECH**：ハードルアーなし。Swing Impact FAT 3.8＋ウェイテッドフックを巻物代替にする
- **混成最強**：HIGH PITCHER 3/8ozを主軸。PEANUT SRは予算に余裕があれば追加

### 約10,000円から追加

- **O.S.P**：BLITZ
- **DAIWA**：STEEZ COVER CHATTER 3/8oz、STEEZ SILENT SHAD 54SP SR
- **KEITECH**：ハードルアーは追加せず、Crazy Flapper 2.8のフリーリグを追加
- **混成最強**：PEANUT SR、STEEZ SILENT SHAD 54SP SRを追加

### 約15,000円から追加

- **O.S.P**：新しい種類を増やさず、HIGH PITCHER / BLITZの色違い・予備
- **DAIWA**：PEANUT DR、STEEZ SILENT SHAD 54SP MRを追加してレンジを広げる
- **KEITECH**：FAT 3.3 / 3.8のサイズ・色違いを追加
- **混成最強**：BLITZ、Swing Impact FAT 3.8、STEEZ SILENT SHAD 54SP MRを追加

---

## ワーム用リグ

### 1. ジグヘッドリグ【5,000円から必須】

- **O.S.P**：HP Shadtail 3.1
- **DAIWA**：STEEZ STIRRING SHAD 2.8 / 3.3
- **KEITECH / 混成最強**：Easy Shiner 3 / Swing Impact 3
- **ジグヘッド**：1.8〜2.7g基本
- **予備ウェイト**：1.3g / 3.5g
- **ライン**：フロロ4〜6lb
- **接続**：ラインをジグヘッドのアイへ直接結ぶ
- **セット方法**：ワームをまっすぐ刺し、フックポイントを背中側から正しく出す
- **使い方**：中層ただ巻き。護岸沿い、流れ、ベイトがいる場所を探す

### 2. ワッキー掛けダウンショット【5,000円から必須】

- **O.S.P**：DoLive Crawler 3.5
- **DAIWA**：STEEZ FINESSE STRAIGHT 4.3
- **KEITECH / 混成最強**：Live Impact 3
- **フック**：マス針 #4を基本
- **シンカー**：ダウンショットシンカー2.7g基本
- **フック〜シンカー**：50〜70cm目安
- **ライン**：フロロ4〜6lb
- **基本構成**：標準のダウンショットではスイベル不要
- **接続**：フックをライン途中に結び、タグエンドをフックアイへ通してフックポイントを上向きにし、そのタグエンドへDSシンカーを直接装着する
- **ワッキー掛け**：ワーム中央付近をマス針で横切るように掛ける
- **使い方**：先行者が入った水門、杭、護岸、見えバス。最後の食わせ

### 3. フリーリグ【O.S.P / KEITECH / 混成最強 10,000円以上で追加】

- **O.S.P**：DoLive Beaver 3.5＋オフセット #1/0〜#2/0目安
- **KEITECH / 混成最強**：Crazy Flapper 2.8＋オフセット #1目安
- **シンカー**：アイ付きフリーリグシンカー3.5〜5g基本
- **ライン**：フロロ10〜14lb
- **接続順**：ライン → アイ付きフリーリグシンカーのアイを通す → オフセットフックへ結ぶ
- **注意**：テキサス用バレットシンカーとは区別する
- **セット方法**：オフセットフックをワームへ正しくセットし、ワームを曲げない
- **使い方**：浮きゴミ、杭、水門、護岸変化、カバー、ボトム

### 4. ウェイテッドフックリグ【KEITECH 5,000円 / 混成最強15,000円で使用】

- **ワーム**：Swing Impact FAT 3.8
- **フック**：ウェイテッドオフセット #2/0目安
- **ウェイト**：1.8〜3.5g程度
- **ライン**：フロロ10〜14lb
- **接続**：ラインをフックアイへ直接結ぶ
- **セット方法**：鼻先をオフセット部へ正しく固定し、フックポイントは背中側へ抜く。ワームを曲げない
- **使い方**：中層〜やや深めを広く巻く
- **KEITECH 15,000円構成**：FAT 3.3を使う場合はオフセット #1/0目安

---

## 今回は参考扱いのリグ

以下は使えるが、**5,000〜15,000円の基本購入セットには含めない**。現地で必要性が出てから追加する。
...
スマホで確認しやすいよう、用途ごとに箇条書きにする。

- **ジグヘッド / ワッキーDS / フィネス**：フロロ4〜6lb
- **小型シャッド**：フロロ6〜8lb
- **クランク（PEANUT / BLITZ）**：フロロ10〜12lb
- **フリーリグ**：フロロ10〜14lb
- **ウェイテッドフック＋Swing Impact FAT**：フロロ10〜14lb
- **スピナーベイト / チャター**：フロロ12〜14lb
...
O.S.P / DAIWA / KEITECH / 混成最強で共通して使う基本小物。

- **ジグヘッド 1.8〜2.7g**：弱い巻き用
- **マス針 #4**：ワッキーDS用
- **DSシンカー 2.7g**：ワッキーDS用

### O.S.P / DAIWA / 混成最強

- **スナップ**：クランク・シャッドを使う場合。サイズはルアーとのバランスを見て選ぶ

### KEITECHのみ

- **ウェイテッドオフセット #2/0、1.8〜3.5g**：Swing Impact FAT 3.8用

## 約10,000円構成で追加

### O.S.P

- **オフセットフック #1/0〜#2/0**：DoLive Beaver 3.5用
- **アイ付きフリーリグシンカー3.5〜5g**：フリーリグ用

### DAIWA

- ワーム用の新しいリグ用品は基本追加不要
- ジグヘッド、マス針、DSシンカーの予備を優先

### KEITECH / 混成最強

- **オフセットフック #1**：Crazy Flapper 2.8用
- **アイ付きフリーリグシンカー3.5〜5g**：フリーリグ用
- ジグヘッド、マス針、DSシンカーの予備

## 約15,000円構成で追加

新しいフィネスリグを増やすより、レンジ追加と消耗品の予備を優先する。
...
- 必要なら1.8 / 3.5gを追加
- マス針#4の予備
- O.S.P構成ではオフセットフック、フリーリグシンカーの予備
- KEITECH構成ではウェイテッド #2/0の予備、FAT 3.3用 #1/0、オフセット #1、フリーリグシンカーの予備
- **混成最強**ではSwing Impact FAT 3.8用ウェイテッド #2/0を追加
...
**使う順番：Swing Impact FAT 3.8 → Easy Shiner 3 → Live Impact 3**

### 約10,000円パターン

5,000円構成に追加する。

- **弱い巻き追加：Swing Impact 3 ×1袋** — 約600〜800円  
  [Amazonで確認](https://www.amazon.co.jp/s?k=ケイテック+スイングインパクト+3インチ)
- **カバー・ボトム：Crazy Flapper 2.8 ×1袋** — 約600〜800円  
  [Amazonで確認](https://www.amazon.co.jp/s?k=ケイテック+クレイジーフラッパー+2.8)
- **オフセットフック #1 ×1袋** — 約350〜500円  
  [Amazonで確認](https://www.amazon.co.jp/s?k=オフセットフック+1+バス)
- **フリーリグシンカー3.5〜5g ×1袋** — 約500円  
  [Amazonで確認](https://www.amazon.co.jp/s?k=フリーリグシンカー+3.5g+5g)
- **Swing Impact FAT 3.8 色違い ×1袋** — 約700〜900円  
  [Amazonで確認](https://www.amazon.co.jp/s?k=ケイテック+スイングインパクトFAT+3.8)
- **Easy Shiner 3 色違い ×1袋** — 約600〜800円  
  [Amazonで確認](https://www.amazon.co.jp/s?k=ケイテック+イージーシャイナー+3インチ)
- **Live Impact 3 色違い ×1袋** — 約600〜800円  
  [Amazonで確認](https://www.amazon.co.jp/s?k=ケイテック+ライブインパクト+3インチ)
- **小物の予備**：約500円
- **総額目安：約9,000〜10,000円**

**使う順番：FAT 3.8 → Easy Shiner / Swing Impact 3 → Crazy Flapper → Live Impact**

### 約15,000円パターン

10,000円構成に追加する。

- **Swing Impact FAT 3.3 ×1袋** — 約700〜900円  
  [Amazonで確認](https://www.amazon.co.jp/s?k=ケイテック+スイングインパクトFAT+3.3)
- **ウェイテッドオフセット #1/0 ×1袋** — 約500〜700円  
  [Amazonで確認](https://www.amazon.co.jp/s?k=ウェイテッド+オフセットフック+1%2F0)
- **Crazy Flapper 2.8 色違い ×1袋** — 約600〜800円  
  [Amazonで確認](https://www.amazon.co.jp/s?k=ケイテック+クレイジーフラッパー+2.8)
- **Swing Impact 3 色違い ×1袋** — 約600〜800円  
  [Amazonで確認](https://www.amazon.co.jp/s?k=ケイテック+スイングインパクト+3インチ)
- **Easy Shiner 3 予備 ×1袋** — 約600〜800円  
  [Amazonで確認](https://www.amazon.co.jp/s?k=ケイテック+イージーシャイナー+3インチ)
- **Live Impact 3 予備 ×1袋** — 約600〜800円  
  [Amazonで確認](https://www.amazon.co.jp/s?k=ケイテック+ライブインパクト+3インチ)
...
ここから下は、今回の5,000〜15,000円セットで**最初から全て購入するための一覧ではない**。既に持っている場合や、現地で不足を感じた場合の参考候補として残す。
